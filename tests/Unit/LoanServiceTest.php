...
class LoanServiceTest extends TestCase
{
    ...
    /**
     * @var \App\Services\LoanService $loanService
     */
    ...
    public function testServiceCanCreateLoanOfForACustomer()
    {
        ...
        /**
         *  [note] This test case will cause a false test, 
         * $total = 5000 
         * $loan->scheduledRepayments()->sum('amount') = 1666 + 1666 + 1667 = 4999
         */
    ...
    public function testServiceCanRepayAScheduledRepaymentConsecutively()
    {
        ...
        /**
         * [note] This test case will cause a false test, 
         * when create a dummy data for scheduledRepaymentThree you fill due_date with 2020-04-20 
         * But how can due_date value changed into 2020-02-20
         */
        $this->assertDatabaseHas('scheduled_repayments', [
            'id' => $scheduledRepaymentThree->id,
            'loan_id' => $loan->id,
            ...
            'outstanding_amount' => 0,
            'currency_code' => $currencyCode,
            'due_date' => '2020-04-20', // 2020-02-20 [note] original value
            'status' => ScheduledRepayment::STATUS_REPAID,
        ]);
    ...
    public function testServiceCanRepayMultipleScheduledRepayments()
    {
        ...
        /**
         * [note] This test case will cause a false test, 
         * when create a dummy data for scheduledRepaymentOne and scheduledRepaymentTwo you fill ammout with 1666 
         * But how can amount value changed into 1667
         */
        $this->assertDatabaseHas('scheduled_repayments', [
            'id' => $scheduledRepaymentOne->id,
            'loan_id' => $loan->id,
            'amount' => 1666, // 1667 [note] original value
            'outstanding_amount' => 0,
            'currency_code' => $currencyCode,
            'due_date' => '2020-02-20',
            'status' => ScheduledRepayment::STATUS_REPAID,
        ...
        $this->assertDatabaseHas('scheduled_repayments', [
            ...
            'loan_id' => $loan->id,
            'amount' => 1666, // 1667 [note] original value
            'outstanding_amount' => 334, // 333 [note] original value 2000 - 1667
            'currency_code' => $currencyCode,
            'due_date' => '2020-03-20',
